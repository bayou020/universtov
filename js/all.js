...
function initPageSliders(){
    (function($){
        ...
        function owl_keynav(el){      
            ...
            var total_items = $(".owl-item").length;
            $(".owl-controls").prepend('<div class="owl_counter"><span class="currect_nav_cnt">1</span> / <span class="total_nav_cnt">'+total_items+'</span></div>');
            $(".owl_counter").css("left", offset.left+10);
            $(".owl-buttons").css("left", offset.left+50);
            $(".owl-next").css("margin-left", "48px");


        }

        // Fullwidth slider
        var home_slider = $(".fullwidth-slider");
        ...
        home_slider.owlCarousel({
            ...
            lazyLoad: true,
            loop: true,
            navigationText: ["<span class='sr-only'>Previous Slide</span> <span class='custom_arrow'>⟵</span>", "<span class='sr-only'>Next Slide</span> <span class='custom_arrow'>⟶</span>"],
